...
class Trainer(object):
    ...
    def train(self):
        ...
        for itr in range(self.start_itr, self.n_itr):
            ...
            encoder_units=random.randint(1, 1000)
            # decoder_units=random.randint(10, 512)
            decoder_units=encoder_units=128
            print(f"decoder_units == {decoder_units}")
            policy = self.policy = MetaSeq2SeqPolicy(meta_batch_size=META_BATCH_SIZE, obs_dim=17, encoder_units=encoder_units, decoder_units=decoder_units, vocab_size=2, learning_rate=1e-3)
            # self.sampler = Seq2SeqMetaSampler(
            #     env=env,
            #     policy=self.policy,
...
if __name__ == "__main__":
    ...
    meta_policy = MetaSeq2SeqPolicy(meta_batch_size=META_BATCH_SIZE, obs_dim=17, encoder_units=64, decoder_units=64,
                                    vocab_size=2, learning_rate=1e-3)
